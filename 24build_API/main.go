...
func main() {
	...
	// seeding
	courses = append(courses, Course{CourseId: "2", CourseName: "MERN stack", CoursePrice: 299, Author: &Author{Fullname: "Siddharth Jain", Website: "lco.dev"}})
	courses = append(courses, Course{CourseId: "4", CourseName: "Angular", CoursePrice: 399, Author: &Author{Fullname: "Siddharth Jain", Website: "lco.dev"}})
